...
CamR= cv2.VideoCapture(2)   # 0 -> Right Camera
...
while True:
    ...
    if (retR == True) & (retL == True):
        ...
        if cv2.waitKey(33) & 0xFF == ord('s'):   # Push "s" to save the images and "c" if you don't want to
    ...
    # End the Programme
    if cv2.waitKey(33) & 0xFF == ord(' '):   # Push the space bar and maintan to exit this Programm
        break
